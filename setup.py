...
setup(
    ...
    url='https://github.com/your-username/auto_codex',
    author='Auto Codex Team',
    ...
    # Project URLs
    project_urls={
        'Bug Reports': 'https://github.com/your-username/auto_codex/issues',
        'Source': 'https://github.com/your-username/auto_codex',
